...
@push('script')
    ...
    <!-- <script script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA1MgLuZuyqR_OGY3ob3M52N46TDBRI_9k&callback=initMap" type="text/javascript"></script> -->
    <script>
        let map;
        let iconFutsal;
        let iconHome;
